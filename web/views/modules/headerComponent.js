    ...
    document.getElementById("header").innerHTML = `
        ...
        <nav class="navegacion">
            <ul class="menu">
                ...
                <li><a href="/web/views/pages/sobremi/sobremi.html">Sobre Mi</a></li>
                ...
                <li><a href="#">Proyectos</a>
                    <ul class="submenu">
                        ...
                        <li><a href="/web/views/pages/tienda/tienda.html" target="_blank">Tienda Online</a></li>
                ...
                <li><a href="/web/views/pages/paginaestatica/paginaestatica.html">Mi Pagina Estatica</a></li>
            </ul>
        </nav>
    </header>
    `;
